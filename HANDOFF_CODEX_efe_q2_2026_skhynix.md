...
**주가**: 7/28 −11% → 7/29 **+3.23%, 종가 1,600,000원**.

> ⚠️ **미확정**: 세전이익·법인세·영업외손익 내역은 **잠정실적 공시에 없다.** 메리츠 추정(세전 101.8조, 키옥시아 영업외 ~40조)은 **프린트 전 추정치**이며 실측이 아니다. 반기보고서(8월 중순) 전까지 **세율·below-OP 분해를 확정치로 쓰지 말 것.**
...
### H3 — 유효세율 (P2, **보류**)
메리츠 추정 세전 101.8조 기준 유효세율 ≈ 7.8% (앵커 16.4%). 지분처분이익 세무처리 추정.
**반기보고서 실측 전까지 앵커 변경 금지.** GEV에서 "일회성으로 왜곡된 분기 세율을 앵커로 오독"한 전례가 있다.
